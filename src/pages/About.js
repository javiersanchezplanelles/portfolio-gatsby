    ...
    return(
        <Layout>
            ...
            <div className="About">
                ...
                <p>As I was learning to code I joined <a href="https://codebar.io/brighton">Codebar</a>, a free weekly programming workshop. It's an amazing initiative
                ...
                <p>After a few months with codebar I was delighted to start an internship at a creative web agency 
                in Brighton, quickly progressing to a full-time role as Junior Front End Developer and 
                continuing to develop my skills in CSS, HTML and JavaScript.</p>
                <p>I have come full circle and currently volunteer as a coach at Codebar, where I hope to inspire newcomers to 
